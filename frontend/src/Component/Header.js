    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <MenuItem component={Link} to="/" onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white'}}>
                Home
            </MenuItem>

            <MenuItem component={Link} to="/dashboard" onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white'}}>
                Dashboard
            </MenuItem>
          </Box>
